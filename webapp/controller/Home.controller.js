...
], (Controller, MessageToast, MessageBox, JSONModel, Sorter, Filter, FilterOperator, FilterType) => {
	"use strict";

	return Controller.extend("odata.openui5.controller.Home", {
		...
		onSort: function () {
			...
			var aStateTextIds = ["sortNone", "sortAscending", "sortDescending"];
			var sMessage;
